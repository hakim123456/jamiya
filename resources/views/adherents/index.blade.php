                        ...
                        <tbody> @foreach($adherents as $adherent) <tr class="odd gradeX">
                                ...
                                <td>
                                    <form action="{{ route('adherents.destroy',$adherent->id) }}" method="POST">
                                        ...
                                        <a class="btn btn-primary" href="{{ route('adherents.edit',$adherent->id) }}">تحيين</a> @csrf @method('DELETE') <button type="submit" class="btn btn-danger">حذف</button>
                                    </form>
                                </td>
                            </tr> @endforeach </tbody>
                    </table>
...
<!-- /.row -->undefinedundefined</div> @endsection